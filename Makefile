...
The 'prepare' target installs toil-topmed's build requirements into the current virtualenv.
...
The 'test' target runs toil-topmed's unit tests. Set the 'tests' variable to run a particular test, e.g.
